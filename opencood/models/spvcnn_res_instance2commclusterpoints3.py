...
class SPVCNNResInstance2commClusterPoints3(nn.Module):
    def __init__(self, args, train=True):
        super(SPVCNNResInstance2commClusterPoints3, self).__init__()
    ...
    def forward(self, data_dict, vis=False):
        ...
        communication_rates_instancecomm = data_dict_vi_cluster['communication_rates']
        ...
        output_dict.update({'psm_single_v': psm_single_v,
                       ...
                       'comm_rate': communication_rates_instancecomm # communication_rates
                       })
        return output_dict
