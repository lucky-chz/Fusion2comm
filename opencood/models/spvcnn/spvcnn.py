...
from opencood.models.spvcnn.basic_block import Lovasz_loss
from opencood.models.spvcnn.basic_block import SparseBasicBlock
from opencood.models.spvcnn.voxel_fea_generator import voxel_3d_generator, voxelization
...
class get_model(nn.Module):
    def __init__(self, config):
        ...
        min_cylinder_space = config['dataset_params']['min_cylinder_space']
        max_cylinder_space = config['dataset_params']['max_cylinder_space']
        self.coors_range_pol = [[min_cylinder_space[0], max_cylinder_space[0]],
                                [min_cylinder_space[1], max_cylinder_space[1]],
                                [min_cylinder_space[2], max_cylinder_space[2]]]
        ...
        self.voxelizer = voxelization(
            ...
            coors_range_pol=self.coors_range_pol,
            spatial_shape=self.spatial_shape,
            scale_list=self.scale_list,
            type=getattr(config['dataset_params'], 'voxellization_type', 'cat')
        )
