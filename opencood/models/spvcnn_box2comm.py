...
from opencood.models.instance_center_modules.instance_center import InstanceCenter, InstanceComm, InstanceCommCluster
from opencood.models.box2comm_modules.box2comm import Box2Comm
...
class SPVCNNInstance2commCluster(nn.Module):
    def __init__(self, args, train=True):
        super(SPVCNNInstance2commCluster, self).__init__()
        ...
        self.box2comm = Box2Comm(args['Box2Comm'])
    ...
    def forward(self, data_dict, vis=False):
        ...
        data_dict['box2comm'] = data_dict_vi
        _, data_dict_vi_cluster = self.box2comm(data_dict_vi, output_dict)
