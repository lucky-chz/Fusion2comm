...
class IntermediateFusionDatasetDAIR_Lidar_occlusion_b5former(Dataset):
    """
    ...
    def retrieve_base_data(self, idx):
        ...
        if self.load_camera_file:
            ...
            data[0]['semseg'] = np.load(os.path.join(self.root_dir, (frame_info["vehicle_image_path"].replace('image', 'semseg_segformerb5')+'.npy')))
            ...
            data[1]['semseg'] = np.load(os.path.join(self.root_dir, (frame_info["infrastructure_image_path"].replace('image', 'semseg_segformerb5')+'.npy')))
