...
class PointPillarWhere2commLogits(nn.Module):
    def __init__(self, args):
        super(PointPillarWhere2commLogits, self).__init__()
    ...
    def forward(self, data_dict, vis=False, fuse_2d=False):
        ...
        if fuse_2d:
            points_logits[uv_nonzero_all] = points_logits[uv_nonzero_all] * 0.5 + 0.5 * sem_logits_feature[uv_nonzero_all]
