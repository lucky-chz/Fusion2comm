...
class SPVCNNInstance2commClusterPoints(nn.Module):
    def __init__(self, args, train=True):
        super(SPVCNNInstance2commClusterPoints, self).__init__()
        ...
        self.instance2comm = InstanceCommCluster(args['InstanceComm'])
    ...
    def forward(self, data_dict, vis=False):
        ...
        _, data_dict_vi_cluster = self.instance2comm(data_dict_vi, data_dict_vi['points_feature'])
