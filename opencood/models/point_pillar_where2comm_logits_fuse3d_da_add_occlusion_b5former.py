...
class PointPillarWhere2commLogitsFuse3DDAAddOcclusionB5former(nn.Module):
    def __init__(self, args):
        super(PointPillarWhere2commLogitsFuse3DDAAddOcclusionB5former, self).__init__()
        ...
        self.logits_img_da = nn.Sequential(
            nn.Conv2d(19, self.pillar_vfe.get_output_feature_dim(), kernel_size=1), #[B, 64, 256, 256]
            DeformableAttention(
    ...
    def forward(self, data_dict, vis=False, fuse_2d=True):
        ...
        # occm.cpu().numpy().tofile('/space/chuhz/workspace/results/heatmap/ours')
