...
class IntermediateFusionDatasetDAIR_Lidar_occlusion(Dataset):
    """
    ...
    def retrieve_base_data(self, idx):
        ...
        if self.load_camera_file:
            ...
            data[0]['semseg'] = np.load(os.path.join(self.root_dir, (frame_info["vehicle_image_path"].replace('image', 'semseg')+'.npy')))
            ...
            data[0]['params']['camera0']['frame_id'] = veh_frame_id
            ...
            data[1]['semseg'] = np.load(os.path.join(self.root_dir, (frame_info["infrastructure_image_path"].replace('image', 'semseg')+'.npy')))
            ...
            data[1]['params']['camera0']['frame_id'] = inf_frame_id
